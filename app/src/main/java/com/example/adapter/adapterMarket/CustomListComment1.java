...
public class CustomListComment1 extends BaseAdapter {

	private Context mContext;
	public  Model_Comment m;
	TextView txt_name,txt_desc;
    public  static Button btn_cmt;
   String result2;

	public CustomListComment1(Context c, Model_Comment m) {
...
try {
	commentdlt(Json_commentlist.model_comment.getAl_comment().remove(position).getId());
}
catch (Exception e){
		...
		class Commentdlt extends AsyncTask<String, Void, String> {
			...
			protected void onPostExecute(String s) {
				...
				if(result2.equals("true")) {
             	...
             	new Json_commentlist(mContext,NewComment.list).execute(CustomGridProductMarket.pid, "p");

					String val="-1";
					int value=Integer.parseInt(val);
					int tv=Integer.parseInt(String.valueOf(NewComment.tv_comment.getText()));
					value=value+tv;


					NewComment.tv_comment.setText(String.valueOf(value));
