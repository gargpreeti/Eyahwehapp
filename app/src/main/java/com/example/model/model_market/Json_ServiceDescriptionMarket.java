...
import com.example.fragment.fragmentMarketTab.Fragment_marketservicedetail;
...
public class Json_ServiceDescriptionMarket extends AsyncTask<String, String, String> {

	public static List<String> list = new ArrayList<String>();
	Context context;
	public  static Model_getServiceDescriptionMarket obj_serviceDescriptionmarket;
    public static  String follow;
	public Json_ServiceDescriptionMarket(Context context) {
	...
	protected void onPostExecute(String result) {
		...
		Fragment_marketservicedetail f=
				new Fragment_marketservicedetail();
