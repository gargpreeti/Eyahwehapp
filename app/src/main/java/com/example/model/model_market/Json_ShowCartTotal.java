...
public class Json_ShowCartTotal extends AsyncTask<String, String, String> {
    ProgressDialog loading;
    Context context;
  Model_showCart model_cart;
    ListView list;
 public static int totalcart;
    public Json_ShowCartTotal(Context context) {
...
//        loading.dismiss();
      ...
      FragmentHome.tv_cart2.setText(String.valueOf(totalcart));
