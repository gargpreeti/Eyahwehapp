...
public class Json_ShowCartTotal6 extends AsyncTask<String, String, String> {
    ProgressDialog loading;
    Context context;
  Model_showCart model_cart;
    ListView list;
 public static int totalcart;
    public Json_ShowCartTotal6(Context context) {
...
//        loading.dismiss();
        ...
        Fragment_marketproductdeatil1.tv_cart7.setText(String.valueOf(totalcart));
