...
public class Json_GetDataMarketService_srch extends AsyncTask<String, String, String> {
    ...
    public Json_GetDataMarketService_srch(Context context,ListView gridView) {
