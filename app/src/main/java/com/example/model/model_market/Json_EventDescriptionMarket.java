...
import com.example.fragment.fragmentMarketTab.Fragment_marketeventdetail;
...
public class Json_EventDescriptionMarket extends AsyncTask<String, String, String> {

	public static List<String> list = new ArrayList<String>();
	Context context;
	public  static Model_getEventDescriptionMarket obj_eventDescriptionmarket;
	public static String follow;
	public Json_EventDescriptionMarket(Context context) {
	...
	protected void onPostExecute(String result) {
		...
		Fragment_marketeventdetail f=
				new Fragment_marketeventdetail();
