...
public class Json_ShowCartTotal1 extends AsyncTask<String, String, String> {
    ProgressDialog loading;
    Context context;
  Model_showCart model_cart;
    ListView list;
 public static int totalcart;
    public Json_ShowCartTotal1(Context context) {
    ...
    protected void onPostExecute(String result) {
       ...
       FragmentMarket.tv_cart.setText(String.valueOf(totalcart));
