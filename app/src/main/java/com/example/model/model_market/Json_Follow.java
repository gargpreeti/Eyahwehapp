...
public class Json_Follow extends AsyncTask<String, String, String> {
    String res;
    Context context;


    public Json_Follow(Context context) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("follow_to", params[1]));
