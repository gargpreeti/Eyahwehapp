...
import com.example.fragment.fragmentMessageTab.Frag_MsgDeatil;
...
public class Json_ShowCartTotal4 extends AsyncTask<String, String, String> {
    ProgressDialog loading;
    Context context;
  Model_showCart model_cart;
    ListView list;
 public static int totalcart;
    public Json_ShowCartTotal4(Context context) {
    ...
    protected void onPostExecute(String result) {
       ...
       Frag_MsgDeatil.tv_cart5.setText(String.valueOf(totalcart));
