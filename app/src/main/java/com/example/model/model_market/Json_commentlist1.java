...
import com.example.fragment.fragmentMarketTab.NewComment1;
...
public class Json_commentlist1 extends AsyncTask<String, String, String> {
    ...
    public Json_commentlist1(Context context) {
