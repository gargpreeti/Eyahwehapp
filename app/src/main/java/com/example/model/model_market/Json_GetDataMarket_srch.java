...
public class Json_GetDataMarket_srch extends AsyncTask<String, String, String> {
    ...
    public Json_GetDataMarket_srch(Context context, ListView gridView) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            if (entity != null) {
                ...
                Log.e("mrkt product srch-----",""+result);
            }
    ...
    protected void onPostExecute(String result) {
     ...
     gridView.setAdapter(new CustomGridProductMarket(context, model_market));
