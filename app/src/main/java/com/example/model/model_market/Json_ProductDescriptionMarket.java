...
public class Json_ProductDescriptionMarket extends AsyncTask<String, String, String> {


	Context context;
    Model_getProductDescriptionMarket obj_productDescriptionmarket;
	public static String follow,ownerid;

	public Json_ProductDescriptionMarket(Context context) {
	...
	protected void onPostExecute(String result) {
		...
		Fragment_marketproductdetail f=new Fragment_marketproductdetail();
