...
public class Json_commentlist extends AsyncTask<String, String, String> {
    ...
    public Json_commentlist(Context context,ListView list) {
    ...
    protected void onPostExecute(String result) {
        ...
        list.setAdapter(new CustomListComment1(context, model_comment));
