...
import com.example.adapter.adapterMarket.CustomListComment3;
...
public class Json_commentlist3 extends AsyncTask<String, String, String> {
    ...
    public Json_commentlist3(Context context,ListView list) {
    ...
    protected void onPostExecute(String result) {
        ...
        list.setAdapter(new CustomListComment3(context, model_comment));
