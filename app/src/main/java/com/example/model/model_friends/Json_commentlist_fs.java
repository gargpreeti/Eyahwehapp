...
import com.example.adapter.adapterFriends.CustomListComment12;
...
public class Json_commentlist_fs extends AsyncTask<String, String, String> {
    ...
    public Json_commentlist_fs(Context context, ListView list) {
    ...
    protected void onPostExecute(String result) {
        ...
        list.setAdapter(new CustomListComment12(context, model_comment));
