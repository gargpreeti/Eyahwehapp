...
import com.example.adapter.adapterFriends.CustomListComment11;
import com.example.model.model_market.Comment;
...
public class Json_commentlist_fp extends AsyncTask<String, String, String> {
    ...
    public Json_commentlist_fp(Context context,ListView list) {
    ...
    protected void onPostExecute(String result) {
        ...
        list.setAdapter(new CustomListComment11(context, model_comment));
