...
public class Json_Friends_Following extends AsyncTask<String, String, String> {
	...
	public CustomGridFriendsFollowing customGridFriendsFollowing;


	public Json_Friends_Following(Context context, CustomGridFriendsFollowing customGridFriendsFollowing) {
		// TODO Auto-generated constructor stub
		this.customGridFriendsFollowing = customGridFriendsFollowing;
	...
	protected String doInBackground(String... params) {
		...
		try {
			...
			if (entity != null) {
				...
				if(al_friendsdetail.size()>0){

					al_friendsdetail.clear();
	...
	protected void onPostExecute(String result) {
		...
		customGridFriendsFollowing.setAddList(model_discover);
