...
public class Json_Friends_Followers extends AsyncTask<String, String, String> {
	...
	public CustomGridFriendsFollowers customGridFriendsFollowers;


	public Json_Friends_Followers(Context context, CustomGridFriendsFollowers customGridFriendsFollowers) {
		// TODO Auto-generated constructor stub
		this.customGridFriendsFollowers = customGridFriendsFollowers;
	...
	protected void onPostExecute(String result) {
		...
		customGridFriendsFollowers.setAddList(model_discover);
