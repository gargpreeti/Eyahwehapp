...
public class Json_Friends_Following_srch extends AsyncTask<String, String, String> {
	...
	public Json_Friends_Following_srch(Context context,GridView grid) {
	...
	protected void onPostExecute(String result) {
		...
		grid.setAdapter(new CustomGridFriendsFollowing(context, model_discover));
