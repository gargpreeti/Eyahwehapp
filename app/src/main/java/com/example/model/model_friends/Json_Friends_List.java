...
import com.example.fragment.fragmentMessageTab.NewMessageFragment;
...
public class Json_Friends_List extends AsyncTask<String, String, String> {

	ProgressDialog loading;

	public static Model_Discover model_discover;
	public static  List<String> list2 = new ArrayList<String>();
	public static ArrayList<FriendsDetail> al_friendsdetail = new ArrayList<FriendsDetail>();
	Context context;
	String user_name;

	public Json_Friends_List(Context context) {
	...
	protected void onPostExecute(String result) {
		...
		fragmentManager
				...
				.replace(R.id.activity_main_content_fragment,
						new NewMessageFragment()).addToBackStack(null).commit();
	}
