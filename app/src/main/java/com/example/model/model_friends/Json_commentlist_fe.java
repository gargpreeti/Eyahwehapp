...
import com.example.adapter.adapterFriends.CustomListComment13;
...
public class Json_commentlist_fe extends AsyncTask<String, String, String> {
    ...
    public Json_commentlist_fe(Context context, ListView list) {
    ...
    protected void onPostExecute(String result) {
        ...
        list.setAdapter(new CustomListComment13(context, model_comment));
