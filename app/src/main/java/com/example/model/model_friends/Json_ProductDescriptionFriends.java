...
import com.example.fragment.fragmentFriendsTab.Fragment_friendsproductdetail;
...
public class Json_ProductDescriptionFriends extends AsyncTask<String, String, String> {

	public static List<String> list = new ArrayList<String>();
	Context context;
	public  static Model_getProductDescriptionMarket obj_productDescriptionmarket;

	public Json_ProductDescriptionFriends(Context context) {
	...
	protected void onPostExecute(String result) {
		...
		Fragment_friendsproductdetail f=
				new Fragment_friendsproductdetail();
