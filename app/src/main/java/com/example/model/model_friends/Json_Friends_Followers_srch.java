...
public class Json_Friends_Followers_srch extends AsyncTask<String, String, String> {
	...
	public Json_Friends_Followers_srch(Context context,GridView grid) {
	...
	protected void onPostExecute(String result) {
		...
		grid.setAdapter(new CustomGridFriendsFollowers(context, model_discover));
