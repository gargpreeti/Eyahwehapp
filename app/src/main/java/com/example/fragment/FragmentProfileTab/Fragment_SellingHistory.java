...
import com.example.model.model_profile.Json_SellingHistory;
import com.example.zotal102.yahwahapp.R;


public class Fragment_SellingHistory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       new Json_SellingHistory(getActivity(),crt_list1).execute(FragmentHome.userid);
