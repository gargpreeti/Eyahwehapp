...
public class NewMessageFragmentFriendsP extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ed_txt.setText(Fragment_discover.tv_to);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String msg=txt_msg.getText().toString().trim();
                    ...
                    new Json_SendMessage(getActivity()).execute(FragmentHome.userid, Fragment_discover.tv_id, msg);
                    txt_msg.setText("");
                }
