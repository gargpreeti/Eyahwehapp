...
import com.example.model.model_friends.Json_commentlist_fp;
import com.example.model.model_market.Json_AddComment;
import com.example.zotal102.yahwahapp.R;
import com.squareup.picasso.Picasso;


public class NewComment_FP extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Picasso.with(getActivity()).load(CustomGridProduct2.p_img).resize(1100,550).into(img);
         tv_comment.setText(CustomGridProduct2.totl_comment);


        new Json_commentlist_fp(getActivity(), NewComment_FP.list).execute(CustomGridProduct2.pid, "p");
        ...
        btn_snd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cmt.equals("")) {
                    ...
                    new Json_AddComment(getActivity()).execute(CustomGridProduct2.pid, FragmentHome.userid, type, cmt);
                    ...
                    ed_comment.setText("");
                    new Json_commentlist_fp(getActivity(), list).execute(CustomGridProduct2.pid, "p");
