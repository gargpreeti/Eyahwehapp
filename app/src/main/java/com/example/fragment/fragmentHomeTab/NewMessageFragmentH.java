...
public class NewMessageFragmentH extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ed_txt.setEnabled(false);
           ...
           FragmentHome.img_cart.setClickable(false);
            ed_txt.setText(Fragment_marketproductdetail.tv_to);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(msg.equals("")){
                    ...
                    new Json_SendMessage(getActivity()).execute(FragmentHome.userid, Fragment_marketproductdetail.tv_id, msg);
                    txt_msg.setText("");
                }
